...
public class BinaryTreeLCANode {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Lowest Common Ancestor of Node 3 and 11 is: "
                + findLowestCommonAncestor(root, root.right.right.right, root.right.right).value);
